...
class CoreDataHelper {
    ...
    static func readNotesFromCoreData(fromManagedObjectContext: NSManagedObjectContext) -> [Noteopolis] {

        var returnedNotes = [Noteopolis]()
        ...
        do {
            ...
            fetchedNotesFromCoreData.forEach { (fetchRequestResult) in
                ...
                returnedNotes.append(Noteopolis.init(
    ...
    static func readNoteFromCoreData(
        noteIdToBeRead:           UUID,
        fromManagedObjectContext: NSManagedObjectContext) -> Noteopolis? {
